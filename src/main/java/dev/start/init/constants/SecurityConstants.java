...
import dev.start.init.constants.user.PasswordConstants;
...
public final class SecurityConstants {
    ...
    public static final String API_V1_AUTH_ROOT_URL = "/api/v1/user";
    public static final String API_V1_AUTH_URL_MAPPING = "/api/v1/user/**";
    public static final String API_V1_AUTH_URL_MAPPING2 = "/api/v1/ariff-set/**";
    ...
    public static final String API_ROLE = "/api/v1/roles";
